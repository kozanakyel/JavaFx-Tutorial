...
public class PropertiesExample {
    ...
    private static void createProperty(){
        ...
        System.out.println("i1 getbean " + i1.getBean()); //null
    }
    ...
    private static void addAndRemoveInvalidationListener(){
        ...
        i1.addListener(invalidationListener); // listeneri ekle
    ...
    private static void bindAndUnbindOnePropertyToAnother(){
        ...
        System.out.println("Calling i1.set7168");
        i1.set(7168);
        System.out.println("i2.get = " + i2.get());
        ...
        System.out.println("Calling i1.set8192");
        i1.set(8192);
        System.out.println("i2.get = " + i2.get());
    }
}
