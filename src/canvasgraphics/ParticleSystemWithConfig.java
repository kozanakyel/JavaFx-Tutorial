...
public class ParticleSystemWithConfig extends GraphicAppConf {
    ...
    private GridPane buildConfigurationRoot() {
        ...
        ColorPicker cbBackgroundColor = new ColorPicker(Color.BLACK);
        ...
        cbBackgroundColor.valueProperty().addListener((a, b, c) -> background(c));
